...
\begin{thebibliography}{9}
    ...
    \bibitem{14} \url{https://www.creative-tim.com/product/black-dashboard-angular}
    \bibitem{15} \url{https://getbootstrap.com/}
    \bibitem{16} \url{https://cs.wikipedia.org/wiki/CORS}
    \bibitem{17} \url{https://azure.microsoft.com/cs-cz/}
    \bibitem{18} \url{https://hub.docker.com/}
    \bibitem{19} \url{https://www.ackee.cz/blog/glossary/cicd/}
    \bibitem{20} \url{https://github.com/}
\end{thebibliography}
